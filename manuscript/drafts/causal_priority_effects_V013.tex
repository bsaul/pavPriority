...
\begin{figure}
\centering
\includegraphics{causal_priority_effects_V013_files/figure-latex/tikz-def-1.pdf}
\caption{Defintion for \(I_t\) graph}
\end{figure}

\begin{figure}
\centering
\includegraphics{causal_priority_effects_V013_files/figure-latex/tikz-swit-1.pdf}
